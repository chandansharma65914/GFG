<h2><a href="https://www.geeksforgeeks.org/problems/check-if-an-array-is-sorted0701--140001/1?page=10&category=Arrays&sortBy=difficulty">Check whether the array is sorted or not</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong>, check whether it is sorted in non-decreasing order. Return </span><span style="font-size: 18px;">true if it is sorted otherwise false.</span></p>
